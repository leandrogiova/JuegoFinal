...
public class Servidor extends Thread{
	...
	public void run() {	
		...
		try {
			...
			System.out.println("Se ha conectado un cliente. Cliente levantado.");		
			...
			do {
				do {
					System.out.println("Esperando confirmacion para empezar a jugar...\n\n");
					juega = in.readInt();
					if(juega == 2) {
						System.out.println("\nJuego Finalizado.");
					...
					System.out.println("Esperando si se va a jugar la revancha...");
					revancha = in.readBoolean();
	...
	/*
	 * escribirArchivo es una funcion que guarda la matriz en el archivo binario
	 * Recibe como argumentos una matriz, el archivo binario a escribir y un PrintWriter para escribir en el mismo
	 * No tiene retorno
	 */
